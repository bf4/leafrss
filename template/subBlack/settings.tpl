...
<TABLE cellpadding="2" cellspacing="1" border="0" class="forumline" ALIGN=CENTER WIDTH=85%>
	...
	<TR>
		<TD ALIGN=CENTER COLSPAN=2 class="row1"><SPAN CLASS="gensmall">NOTE: Date formatting is for the PHP <A HREF="http://us.php.net/manual/en/function.date.php">date()</A> command</SPAN></TD>
	</TR>
	<TR>
