...
<TABLE cellpadding="2" cellspacing="1" border="0" class="forumline" ALIGN=CENTER WIDTH=85%>
  <TR>
  	<TH COLSPAN=9>RSS Feed Editor</TH>
  </TR>
  <TR>
...
{cycle values="row1,row2,row3" assign=cellClass}
	<TR>
		...
		<TD CLASS="{$cellClass}" ALIGN=CENTER><SPAN CLASS="gen"><SPAN CLASS="{$feeds[feed].rowcolor}">{$feeds[feed].wlCount}</SPAN></SPAN></TD>
		<TD CLASS="{$cellClass}" ALIGN=CENTER><SPAN CLASS="gen"><SPAN CLASS="{$feeds[feed].rowcolor}">{$feeds[feed].blCount}</SPAN></SPAN></TD>
...
{/section}
	<TR>
		<TD ALIGN=CENTER COLSPAN=9 CLASS="cat"><SPAN CLASS="cattitle">{$formTitle}</TD>
	</TR>
	<TR>
		<TD ALIGN=RIGHT COLSPAN=4 CLASS="row1"><SPAN CLASS="gen">Feed Description:</SPAN></TD>
		<TD COLSPAN=5 CLASS="row1"><INPUT TYPE=TEXT SIZE=64 MAXLENGTH=128 NAME="Description" VALUE="{$Description}"></TD>
	</TR>
	<TR>
    <TD ALIGN=RIGHT COLSPAN=4 CLASS="row1"><SPAN CLASS="gen">Feed URL:</SPAN></TD>
    <TD COLSPAN=5 CLASS="row1"><INPUT TYPE=TEXT SIZE=64 MAXLENGTH=128 NAME="URL" VALUE="{$URL}"></TD>
	</TR>
	<TR>
		<TD ALIGN=RIGHT COLSPAN=4 CLASS="row1"><SPAN CLASS="gen">Feed Home Page URL:</SPAN></TD>
		<TD COLSPAN=5 CLASS="row1"><INPUT TYPE=TEXT SIZE=64 MAXLENGTH=128 NAME="homePageURL" VALUE="{$homePageURL}"></TD>
	</TR>
	<TR>
		<TD ALIGN=RIGHT COLSPAN=4 CLASS="row1"><SPAN CLASS="gen">Notes:</SPAN></TD>
	...
	<TR>
		<TD ALIGN=CENTER COLSPAN=9 CLASS="row1"><INPUT TYPE=SUBMIT VALUE="{$buttonName} Feed"></TD>
	</TR>
</TABLE>
</FORM>
